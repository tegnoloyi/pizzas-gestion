...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
    ...
    <h2 class="text-2xl font-black text-gray-800 tracking-tight mb-8">Añadir Producto a Barra</h2>

    <form action="{{ route('barra.store') }}" method="POST" class="space-y-6">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="number" step="0.01" name="precio" required placeholder="Ej. 129.99" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-amber-400 outline-none">
        </div>
        <div>
